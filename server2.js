...
app.get('/getStudent/:usn', (req, res) => {
...
// app.put('/updateStudent/:usn', (req, res) => {
//     const usn = req.params.usn;
//     const updatedData = req.body;
//     let student = students.find(s => s.usn === usn);
//     if (student) {
...
app.post('/generateBill/:usn', (req, res) => {
    const usn = req.params.usn;
    const student = students.find(s => s.usn === usn);
    if (student) {
        res.send(`Bill generated for ${student.name}`);
    } else {
        res.status(404).send('Student not found');
    }
});
...
//fetching student details update form.
// app.get('/getStudent/:usn', (req, res) => {
//   const usn = req.params.usn;
//   const student = students.find(s => s.usn === usn);
//   if (student) {
...
//   }
// });
//updating student details in update form
app.put('/updateStudent/:usn', (req, res) => {
  const usn = req.params.usn;
  const updatedData = req.body;
  let student = students.find(s => s.usn === usn);
